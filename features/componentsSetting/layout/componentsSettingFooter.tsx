...
import { componentsSettingFooterType } from '../types/componentsSettingType';


function componentsSettingFooter({
  workspace,
  activePage,
}: componentsSettingFooterType) {
   return (
...
export default componentsSettingFooter
