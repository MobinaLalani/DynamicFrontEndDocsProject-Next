    ...
    <Popover
      ...
      trigger={
        <button
          ...
          className={
            triggerClassName ??
            "flex h-10 w-10 items-center justify-center rounded-full border border-sky-400 bg-sky-500 text-white shadow-sm transition hover:border-sky-500 hover:bg-sky-600"
          }
        >
      ...
      <div dir="rtl" className={panelClassName ?? "w-[200px] p-4"}>
        <div className="space-y-3">
          <div className="flex items-start justify-between gap-3">
            ...
            <span className="inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-medium text-slate-700">
