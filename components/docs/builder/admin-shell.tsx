...
export function SaveChangesBanner({
  hasUnsavedChanges,
  isSaving,
  message,
  onSave,
      ...
      >
        <section className="space-y-2">
          ...
          <button
            ...
            className={
              isOpen ? expandedNavButtonClass("editor") : collapsedNavButtonClass("editor")
            }
            title="ویرایش صفحه"
          >
          ...
          <button
            ...
            className={
              isOpen ? expandedNavButtonClass("blocks") : collapsedNavButtonClass("blocks")
            }
          ...
          <button
            ...
            className={
              isOpen ? expandedNavButtonClass("preview") : collapsedNavButtonClass("preview")
            }
            title="پیش‌نمایش"
          >
            {isOpen ? "پیش‌نمایش" : "پ"}
          ...
          <button
            ...
            className={
              isOpen ? expandedNavButtonClass("json") : collapsedNavButtonClass("json")
            }
            title="JSON ساختار"
          >
            ...
            return (
              <div key={group.id} className="space-y-3">
                ...
                <div className="space-y-2">
                  {groupPages.map((page) => {
                    const isActive =
                      activeView !== "create-page" && selectedPageSlug === page.slug;
